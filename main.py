...
def show_attn(data, idx_example=0):
...
if __name__ == '__main__':
    ...
    train_dataset, test_dataset, X_train_time, X_test_time = process_data(day_map, time_list, train_length, forcast_window, time=True)
    ...
    for e, epoch in enumerate(range(epochs)):
        ...
        print("Epoch {}: Train loss: {:.3f} \t R_p={:.3f}\tcost_time={:.3f}s".format(e + 1,
